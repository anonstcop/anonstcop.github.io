...
//   this.skippedIntro = false;
  ...
  this.brandDescription = [
    "The corrupt fear us. The honnest support us. The heroic join us.",
    "We are Anonymous. We are Legion. We do not Forgive. We do not Forget. Expect us."
  ];

  this.titleChanger = function(text, delay) {
    text = text || ["We", "Shall", "Make", "Justice"];
    delay = delay || 2000;
  ...
  this.iconChanger = function(urls, delay = 2000) {
    if (!urls) return;

    // delay = delay || 2000; <- don't do this
